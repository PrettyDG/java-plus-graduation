...
public class KafkaConfig {
    ...
    @Bean
    public ConsumerFactory<String, EventSimilarityAro> eventSimilarityConsumerFactory() {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, EventSimilarityAro> eventSimilarityKafkaListenerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, EventSimilarityAro> factory =
                new ConcurrentKafkaListenerContainerFactory<>();
